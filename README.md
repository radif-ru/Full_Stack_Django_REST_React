...
#### Система прав:
> 1. Администраторы (Джанговские и из моих групп зависимостей) могут всё.
> 2. Загружать, удалять и изменять размеры изображений могут авторизованные пользователи
...
>
> https://backend.radif.ru/api/images/1/ - `GET`, `DELETE`, `HEAD`, `OPTIONS` - Получение детальной информации об изображении. Удаление изображения
> 
> https://backend.radif.ru/api/images/1/resize/ - `POST`, `OPTIONS` - Изменение размера изображения
>

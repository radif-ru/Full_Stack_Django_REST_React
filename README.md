...
> В проекте нет упора на вёрстку или стили - при желании делаю `Pixel Perfect` под любой дизайн, работаю с `препроцессорами`, `переменными`, `миксинами`, `расширениями`, импортами для стилей и т.д...

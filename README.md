...
>
> `mixer` (v. 7.2.0), тянет за собой `Faker` (v. 9.8.2) и другие пакеты, подробнее в `requiremets.txt`. Mixer - удобная библиотека для генерации данных для тестов, поддерживает разные фреймворки
>
